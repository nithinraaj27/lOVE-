  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
          ...
          body: Stack(
            children: [
              Image.network('https://images.unsplash.com/photo-1521033719794-41049d18b8d4?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDR8fGxvdmV8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
              ...
              Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Image.asset('assets/shape.png',height: 75,width: 75,color: Colors.white,),
                  ),
                  SizedBox(height: 20,),
                  Container(
                  ...
                  Container(
                    ...
                    child: Image.asset('assets/sh.png',height: 75,width: 75,color: Colors.white,),
                  ),
                  SizedBox(height: 35,),
                  InkWell(
                    onTap: () => press(),
